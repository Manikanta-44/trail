...
let i = 0;
let i2 = 1;
let target1 = document.querySelector(".timeline .timeline-list");
let target2 = document.querySelectorAll(".timeline .timeline-list .timeline-lists");

const timeline_events = document.querySelectorAll(".timeline-list .timeline-lists");
